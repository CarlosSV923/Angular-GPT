...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadComponent: () =>
          import(
            './presentation/pages/audioToText.page/audioToText.page.component'
          ),
        data: {
      ...
      },
      {
        ...
        loadComponent: () =>
          import(
            './presentation/pages/imageGeneration.page/imageGeneration.page.component'
          ),
        data: {
      ...
      },
      {
        ...
        loadComponent: () =>
          import(
            './presentation/pages/ImageTunning.page/ImageTunning.page.component'
          ),
        data: {
